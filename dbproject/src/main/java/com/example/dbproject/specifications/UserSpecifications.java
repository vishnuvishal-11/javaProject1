...
@Data
public class UserSpecifications implements Specification<Users> {
    ...
    @Override
    public Specification<Users> and(Specification<Users> other) {
        return Specification.super.and(other);
    }

    @Override
    public Specification<Users> or(Specification<Users> other) {
