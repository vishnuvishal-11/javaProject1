...
public class CallEventListener {
    ...
    public CallEventListener(CallBack callback) {
        this.callback=callback;
    }

    public void doAsynFuctions() throws ParseException {
...
//        observableSubject1.add(observer2);
    ...
    public static void main(String[] args) throws ParseException {
        ...
        CallEventListener callEventListener=new CallEventListener(callback);
        callEventListener.doAsynFuctions();
